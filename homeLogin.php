...
<body>
        ...
        <div class="main_home">
            ...
            <div class="full_bar">
                ...
                <div class="left_bar">
                    ...
                    <section>
                        <?php
                        include '/xammp/htdocs/vsh_movie/list_mv.php';
                        ?>
                    </section>
                    ...
                    <section>
                        ...
                        <br>
                        <?php
                        include '/xammp/htdocs/vsh_movie/comment.php';
                        ?>
                    </section>
                </div>
                ...
                <div class="right_bar">
                    <?php
                    include '/xammp/htdocs/vsh_movie/rightbar.php'
                    ?>
                </div>
            </div>
            ...
            <section>
                <div class="contact" id="contact">
                    ...
                    <?php
                    include '/xammp/htdocs/vsh_movie/contact.php';
                    ?>
                </div>
            </section>
        </div>
    ...
    <footer>
        <?php
        include '/xammp/htdocs/vsh_movie/footer.php';
        ?>
    </footer>
