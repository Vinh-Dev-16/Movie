 <?php
  ...
  $rowsPerPage = 05;
  $perRow = ($page - 1) * 05;
  $query1 = "SELECT * FROM account where role =1 LIMIT $perRow,$rowsPerPage";
 ...
 <body>
   ...
   <div class="container">
           ...
           <?php
            ...
            ?>
             <tr>
               ...
               <td>
                 <div class="curd_icon">
                   <a title="Xóa" div class="curd" onclick="return confirm('Bạn có muốn xóa admin này không?')" href="deleteAdmin.php?unameid=<?php echo $row['id']; ?>" style="color:#db183c;">
                     <ion-icon name="trash"></ion-icon>
                   </a>
                   <a title="Thêm" div class="curd" href="/registeradmin.php">
     ...
     <ul class="pagination">
       ...
       <?php
        $query2 = "SELECT * FROM account where role =1 ";
