                            ...
                            <div class="left_es">
                                <div class="video">
                                    ...
                                    if ($run) {
                                        while ($row = mysqli_fetch_assoc($run)) {
                                    ?>
                                            <iframe width="800" height="560" src="<?php echo $row['es_url'] ?>" title="Phim" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
