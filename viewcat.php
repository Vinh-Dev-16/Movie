...
$rowsPerPage = 15;
$perRow = ($page - 1) * 15;
$query4 = "SELECT * FROM movie,category where movie.cat_id=category.id  LIMIT $perRow,$rowsPerPage";
$run4 = mysqli_query($con, $query4);
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query1 = "SELECT * FROM category,cat_mv where category.id=cat_mv.category_id and id = $id";
                            ...
                            <div class="left_view">
                                <section>
                                    <div class="genre">
                                        ...
                                        <div class="mv_genre">
                                            <?php
                                            $query = "SELECT * FROM cat_mv,category,movie where category.id=cat_mv.category_id and cat_mv.mv_id=movie.id and category.id=$id ORDER BY mv_date DESC";
                                    ...
                                    <ul class="pagination">
                                        ...
                                        <?php
                                        $id = $_GET['id'];
                                        $query3 = "SELECT * FROM cat_mv,category,movie where category.id=cat_mv.category_id and cat_mv.mv_id=movie.id and category.id=$id ";
                                        $run3 = mysqli_query($con, $query3);
                                        $total = mysqli_num_rows($run3);
                                        $total_page = ceil($total / $rowsPerPage);

                                        if ($page > 1) {
                                            echo "<li ><a class='prev' href='viewcat.php?id=$id&page=" . ($page - 1) . "'  >Prev</a></li>";
                                        } else {
                                            echo "<li ><a class='prev' href='viewcat.php?id=$id&page=" . ($total_page) . "'  >Prev</a></li>";
                                        }
                                        for ($i = 1; $i <= $total_page; $i++) {
                                            if ($i  > $page - 3 && $i < $page + 3) {
                                                echo "<li ><a class='pageNumber' href='viewcat.php?id=$id&page=" . ($i) . "'  >$i</a></li>";
                                            }
                                        }

                                        if ($total_page > $page) {
                                            echo "<li ><a class='next' href='viewcat.php?id=$id&page=" . ($page + 1) . "'  >Next </a></li>";
                                        } else {
                                            echo "<li ><a class='next' href='viewcat.php?id=$id&page=1'  >Next </a></li>";
                                        }
