...
$rowsPerPage = 15;
$perRow = ($page - 1) * 15;
$query4 = "SELECT * FROM movie,nation where movie.mv_nation=nation.id  LIMIT $perRow,$rowsPerPage";
$run4 = mysqli_query($con, $query4);
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query1 = "SELECT * FROM nation where id = $id";
                                ...
                                <section>
                                    <div class="genre">
                                        <div class="name_genre">
                                            <h3><?php echo $row1['nation_name'] ?></h3>

                                        </div>
                                        <div class="mv_genre">
                                            <?php
                                            $query = "SELECT * FROM nation,movie where nation.id=movie.mv_nation and nation.id=$id ORDER BY mv_date DESC";
                                    ...
                                    <ul class="pagination">
                                        ...
                                        <?php
                                        $id = $_GET['id'];
                                        $query3 = "SELECT * FROM nation,movie where nation.id=movie.mv_nation and nation.id=$id ";
                                        $run3 = mysqli_query($con, $query3);
                                        $total = mysqli_num_rows($run3);
                                        $total_page = ceil($total / $rowsPerPage);

                                        if ($page > 1) {
                                            echo "<li ><a class='prev' href='viewnation.php?id=$id&page=" . ($page - 1) . "'  >Prev</a></li>";
                                        } else {
                                            echo "<li ><a class='prev' href='viewnation.php?id=$id&page=" . ($total_page) . "'  >Prev</a></li>";
                                        }
                                        for ($i = 1; $i <= $total_page; $i++) {
                                            if ($i  > $page - 3 && $i < $page + 3) {
                                                echo "<li ><a class='pageNumber' href='viewnation.php?id=$id&page=" . ($i) . "'  >$i</a></li>";
                                            }
                                        }

                                        if ($total_page > $page) {
                                            echo "<li ><a class='next' href='viewnation.php?id=$id&page=" . ($page + 1) . "'  >Next </a></li>";
                                        } else {
                                            echo "<li ><a class='next' href='viewnation.php?id=$id&page=1'  >Next </a></li>";
                                        }
